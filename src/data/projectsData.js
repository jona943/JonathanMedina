export const projectsData = [
  {
    ...
    slides: [
      ...
      { src: 'assets/img/proyectos-TI/Smartfi-Momentum-2.jpg', alt: 'SmartFit Momentum 2' },
      { src: 'assets/img/proyectos-TI/Smartfi-Momentum-3.jpg', alt: 'SmartFit Momentum 3' },
      { src: 'assets/img/proyectos-TI/Smartfi-Momentum-4.jpg', alt: 'SmartFit Momentum 4' },
    ...
    links: [
      ...
      { label: 'Prototipo Lovable', url: 'https://huggle-web-canvas.lovable.app/', icon: 'fas fa-paint-brush' }
    ]
  },
  {
    id: 'nubia',
    ...
    slides: [
      ...
      { src: 'assets/img/proyectos-TI/NubIA-3.jpeg', alt: 'NubIA Frontend 3' },
      { src: 'assets/img/proyectos-TI/NubIA-4.jpeg', alt: 'NubIA Frontend 4' }
    ],
    description: 'Interfaz moderna y funcional para un asistente de IA enfocado en emprendedores. Lideré el desarrollo del frontend y la arquitectura del repositorio.',
    links: [
      { label: 'Ver Repositorio', url: 'https://github.com/jona943/hackathon-TiendaNube', icon: 'fab fa-github' }
    ]
  },
  {
    id: 'almalocal',
  ...
  {
    id: 'localdrop',
    date: 'Servicio LAN - Redes Locales',
    title: 'LocalDrop',
    slides: [
      { src: 'assets/img/proyectos-TI/LocalDrop-1.jpeg', alt: 'LocalDrop 1' },
      { src: 'assets/img/proyectos-TI/LocalDrop-2.jpeg', alt: 'LocalDrop 2' },
      { src: 'assets/img/proyectos-TI/LocalDrop-3.jpeg', alt: 'LocalDrop 3' },
      { src: 'assets/img/proyectos-TI/LocalDrop-4.jpeg', alt: 'LocalDrop 4' }
    ],
    description: 'Transferencia de archivos optimizada para redes LAN, facilitando el intercambio de datos entre dispositivos locales de forma rápida y segura.',
    links: [
      { label: 'Ver Repositorio', url: 'https://github.com/jona943/LocalDrop', icon: 'fab fa-github' }
    ]
  },
  {
    id: 'playcat',
    ...
    slides: [
      ...
      { src: 'assets/img/proyectos-TI/gato2.jpeg', alt: 'Play Cat XO 2' },
